export default function Logo() {
  return (
    <div className="">
      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 256 256" enableBackground="new 0 0 256 256" xmlSpace="preserve" className="text-[--text-color] w-[14px] mt-[3px] mb-[4px] h-[14px]"  id="logo">
